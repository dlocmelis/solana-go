...
[![GoDoc](https://pkg.go.dev/badge/github.com/dlocmelis/solana-go?status.svg)](https://pkg.go.dev/github.com/dlocmelis/solana-go@v1.11.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/dlocmelis/solana-go/releases)
[![Build Status](https://github.com/dlocmelis/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/dlocmelis/solana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/dlocmelis/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/dlocmelis/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/dlocmelis/solana-go)](https://goreportcard.com/report/github.com/dlocmelis/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/dlocmelis/solana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/dlocmelis/solana-go@v1.11.0
```
...
You can wait for a transaction confirmation using the `github.com/dlocmelis/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/dlocmelis/solana-go/programs/address-lookup-table"
...
import (
  ...
  "github.com/dlocmelis/solana-go"
  "github.com/dlocmelis/solana-go/programs/system"
  "github.com/dlocmelis/solana-go/rpc"
...
import (
  ...
  "github.com/dlocmelis/solana-go/rpc"
  "github.com/dlocmelis/solana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/dlocmelis/solana-go/programs/system"
  "github.com/dlocmelis/solana-go/rpc"
  confirm "github.com/dlocmelis/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/dlocmelis/solana-go/rpc/jsonrpc"
  "github.com/dlocmelis/solana-go/rpc/ws"
  "github.com/dlocmelis/solana-go/text"
)
